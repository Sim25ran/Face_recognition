...
firebase_admin.initialize_app(cred,{
    ...
    'storageBucket':"faceattendancerealtime-56570.appspot.com"
})
...
modePathList=os.listdir(folderModePath) #gives the list of files in mode
imgModeList=[]
    ...
    if faceCurFrame:
        ...
        if counter !=0:
          ...
          if counter == 1:
            ...
            datetimeObject = datetime.strptime(studentInfo['last_attendance_time'].split('.')[0], '%Y-%m-%d %H:%M:%S')
